                            ...
                            <div class="col-12">
                                ...
                                <div class="tab-content ml-1" id="myTabContent">
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 col-md-2 col-5">
                                                <label class="fieldText">Giới thiệu bản thân</label><i
                                                    class="fa fa-address-book"></i>
                                            </div>
                                            <div class="col-md-8 col-6">
                                                    <textarea rows="5" style="width: 100%;background-color: white"
                                    ...
                                    <div class="tab-pane fade" id="connectedServices" role="tabpanel"
                                        ...
                                        <form method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-6">
                                                    <div class="row">
                                                        <div class="col-md-6"><input type="date" name="date"
                                                                                     class="dateStyle nameStyle"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-6">
                                                    <div class="row">
                                                        <div class="col-md-6"><input type="text" name="nickname"
                                                                                     value="{{$user->nickname}}"
                                                                                     class="nameStyle"></div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-6">
                                                    <textarea rows="5" name="info" style="width: 100%"
